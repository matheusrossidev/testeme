...
const loadingTexts = [
  "Gerando questões...",
  "Libertando o poder da curiosidade...",
  "Mergulhando fundo no oceano de perguntas..",
  "Aproveitando o conhecimento coletivo do cosmos...",
  "Acendendo a chama da maravilha e da exploração...",
];
