  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl">Droga, é o TesteMe!</DialogTitle>
          <DialogDescription>
            <div className="flex items-center gap-3 my-2">
              <p className="flex items-center">
                ...
                <Link
                  ...
                  href="https://github.com/matheusrossidev"
                >
                  GitHub
                </Link>
              </p>
            ...
            Você ta cansado ou cansada de ser um ásno quando se trata dos seus conhecimentos gerais? Bora testar o TesteMe, essa plataformazinha vai melhorar sua experiência com testes e desafiar seus conhecimentos em qualquer assunto!
            </p>
            <hr />
            <p className="my-2 font-semibold">
              <h4 className="text-base font-semibold">Esta porra foi feita com:</h4>
